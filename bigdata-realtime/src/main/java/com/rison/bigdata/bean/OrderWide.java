...
public class OrderWide {
    ...
    public OrderWide(com.rison.bigdata.bean.OrderInfo orderInfo, com.rison.bigdata.bean.OrderDetail orderDetail) {
        mergeOrderInfo(orderInfo);
        mergeOrderDetail(orderDetail);
    }

    public void mergeOrderInfo(com.rison.bigdata.bean.OrderInfo orderInfo) {
        if (orderInfo != null) {
    ...
    public void mergeOrderDetail(com.rison.bigdata.bean.OrderDetail orderDetail) {
        if (orderDetail != null) {
